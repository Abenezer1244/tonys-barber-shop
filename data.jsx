...
const SERVICES_PREVIEW = [
  { id: "signature", name: "The Signature Cut", price: "65", duration: "60 min", desc: "Consultation, shampoo, scissor + clipper, hot-towel finish, neck shave, scalp massage, style.", img: "img/shave-portrait.jpg", flagship: true },
  { id: "classic", name: "Classic Cut", price: "45", duration: "45 min", desc: "Sharp, straightforward haircut tailored to you. Includes wash and finish.", img: "img/cut-fade-2.jpg" },
  { id: "skinfade", name: "Skin Fade", price: "55", duration: "50 min", desc: "Tight skin fade, blended clean from skin to length. Razor detail at the edges.", img: "img/cut-fade-1.jpg" },
  { id: "shave", name: "Hot-Lather Straight Razor", price: "55", duration: "45 min", desc: "Old-school straight razor shave. Hot towels, lather, the works. Sit back.", img: "img/tony-at-work.jpg" },
  { id: "beard", name: "Beard Trim & Line-Up", price: "28", duration: "25 min", desc: "Shape, line, and trim. Hot towel and beard oil to finish.", img: "img/cut-textured.jpg" },
  { id: "kids", name: "Kids Cut (Under 12)", price: "32", duration: "30 min", desc: "Patience and a steady hand for the next generation. First-timers welcome.", img: "img/interior-chairs.jpg" },
];
...
const TEAM = [
  { name: "Tony", role: "Master Barber & Owner", years: "30+ years", img: "img/tony-at-work.jpg",
  ...
  { name: "Marcus", role: "Senior Barber", years: "12 years", img: "img/cut-fade-1.jpg",
  ...
  { name: "Diego", role: "Barber", years: "6 years", img: "img/cut-fade-2.jpg",
  ...
  { name: "James", role: "Apprentice Barber", years: "2 years", img: "img/cut-textured.jpg",
