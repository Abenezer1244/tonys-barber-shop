...
function CareersPage({ navigate }) {
  return (
    <div className="page-fade">
      <section className="page-hero">
        <div className="container">
          <p className="eyebrow eyebrow-cream">— Careers</p>
          <h1 className="display h1" style={{ color: "var(--bg)", marginTop: 12 }}>Cut hair.<br/>Get paid well.<br/>Go home on time.</h1>
          <p className="lede">We hire barbers who care about the work and the people in their chair. If that's you, we should talk.</p>
        </div>
      </section>
        ...
        <div className="container">
          <div className="split">
            <div>
              ...
              <h2 className="display h2" style={{ marginTop: 8 }}>It's a barbershop.<br/>Not a sales floor.</h2>
            </div>
            <div>
              <p className="lede">No retail quotas. No pressure to upsell. The chairs aren't packed shoulder-to-shoulder. The shop closes at 7pm and stays closed.</p>
              <p className="lede" style={{ marginTop: 16 }}>Pay is commission with a guarantee — most barbers clear $75K–$110K/year between booking, walk-ins, and tips. Plus health stipend, paid sick days, and education budget for shows and certifications.</p>
            </div>
          </div>
          ...
          <div style={{ marginTop: 64, display: "flex", flexDirection: "column", gap: 16 }}>
            <div className="role-card">
              <div>
                <h3>Master Barber</h3>
                <p>5+ years experience, full WA license, established clientele welcome. Commission + guarantee.</p>
              </div>
            ...
            <div className="role-card">
              <div>
                <h3>Senior Barber</h3>
                <p>2+ years in a chair, comfortable with skin fades, beard work, and walk-ins. Full-time or part-time.</p>
              </div>
              <button className="btn btn-primary">Apply</button>
            </div>
            <div className="role-card">
              <div>
                <h3>Apprentice</h3>
                <p>Currently in barber school or just licensed. Mentored hours, real chair time, eventual full book. Hourly + tips.</p>
              </div>
              <button className="btn btn-primary">Apply</button>
            </div>
          </div>

          <div style={{ marginTop: 56, padding: 32, background: "var(--bg-cream)", borderRadius: 10 }}>
            <p className="eyebrow">— No openings? Send a hello anyway.</p>
            <p className="lede" style={{ marginTop: 8 }}>We keep good resumes on file. Email <a href="mailto:hi@tonysbarber.example" style={{ color: "var(--brass-deep)", borderBottom: "1.5px solid var(--brass)" }}>hi@tonysbarber.example</a> with a quick intro and a few photos of your work.</p>
          </div>
        </div>
      </section>
    </div>
...
Object.assign(window, { FAQPage, CareersPage, BookPage });
