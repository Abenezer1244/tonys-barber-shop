  ...
  return (
    <div className="page-fade">
      ...
      <section className="hero">
        <div className="hero-img" style={{ backgroundImage: "url('img/hero.webp')" }} />
      ...
      <section className="section-pad section-dark">
        <div className="container">
          <div className="split">
            <div className="split-img" style={{ backgroundImage: "url('img/tony-at-work.jpg')" }} />
            <div>
      ...
      <section className="section-pad-sm">
        <div className="container">
          ...
          <div className="gallery-grid">
            {[
              "img/cut-fade-1.jpg", "img/cut-fade-2.jpg", "img/cut-textured.jpg",
              "img/shave-portrait.jpg", "img/interior-chairs.jpg", "img/tony-at-work.jpg",
              "img/storefront-night.jpg", "img/cut-fade-1.jpg", "img/cut-fade-2.jpg",
              "img/cut-textured.jpg", "img/shave-portrait.jpg", "img/interior-chairs.jpg",
            ].map((src, i) => (
